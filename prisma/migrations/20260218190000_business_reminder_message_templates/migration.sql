...
ADD COLUMN "reminder_template" TEXT NOT NULL DEFAULT 'Lembrete: você tem um agendamento de {{service_name}} com {{professional_name}} {{day_with_preposition}} às {{time}}.',
